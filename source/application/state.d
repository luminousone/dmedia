...
class State {
	 ...
	 *
	 */
	public void onKeyboardEvent( bool pressed, uint key, dml_window window ) {
	}
	 ...
	 *
	 */
	public void onResizeEvent( uint x, uint y, uint w, uint h, dml_window ) {
	}
	 ...
	 *
	 */
	public void onGainedFocusEvent( dml_window window ) {
	}
	 ...
	 *
	 */
	public void onLostFocusEvent( dml_window window ) {
	}
	 ...
	 *
	 */
	public void onCloseEvent( dml_window window ) {
	}
